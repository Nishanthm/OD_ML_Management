  ...
  redirect =event=>{
	...
	render() {
        ...
        <title>OD/ML</title>
          ...
          <div className="odlist" style={{padding:'200px 50px'}}>
          <center><span><h1>Apply Pass</h1></span></center>
          <br></br>
          <br></br>
            <form id='passform'>
              <fieldset>
                ...
                <select className="input-field" name="type">
                  ...
                  <option value="ML">Ordinary Leave</option>
                </select>
                <br /><br />
                ...
                <br></br>
                <label htmlFor="field6"><span>Upload Document link <span className="required">*</span></span><input type="text" className="input-field" name="ulink" defaultValue="" required/></label><br />
                <br></br>
                ...
                <br></br>
                <center><button type="submit" onClick={this.redirect}><h2>Submit</h2></button></center>
              </fieldset>
